...
@section('content')
    ...
    <div class="row"style="margin: 110px 40px;
        ...
        <div class="col-sm-12">
            ...
            <form class="form" action="/profile/{{ $user->id }}" method="post" enctype="multipart/form-data">
                ...
                <div class="text-center">
                    <img src="/images/{{ $user->image }}" class="avatar rounded-circle img-thumbnail" alt="avatar"
                        width="180px" />
                ...
                <div class="form-group">
                    <div class="col-xs-6">
                        ...
                        <input type="text" class="form-control" id="location" placeholder="somewhere" name="location"
                            value="{{ $user->location }}" />
                    </div>
                </div>
                <div class="form-group">
